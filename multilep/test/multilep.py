...
process.blackJackAndHookers = cms.EDAnalyzer('multilep',
  ...
  storeJecSourcesAll            = cms.untracked.bool('storeJecSourcesAll' in extraContent),
  storeJecSourcesGrouped        = cms.untracked.bool('storeJecSourcesGrouped' in extraContent),
